...
<script type="text/javascript">
	var i = "0";
	function deleteCNews(newsId) {
		i = newsId;
	}
	function deleteCNewsButton() {
...
<body class="gray-bg">
 ...
 --%>
 							 <a href="javascript:void(0)" onclick="deleteCNews('${p.newsId}')"  class="btn btn-danger btn-xs" role="button" class="btn btn-danger btn-xs" data-toggle="modal"
...
<%-- 					<a href="${pageContext.request.contextPath }/deleteCNews?" id="deleteCNewsBt" class="btn btn-danger" role="button" >删除</a>  
 ...
 --%>				
				...
				<button type="button" class="btn btn-default" data-dismiss="modal">算了</button>
 				    <button class="btn btn-danger" onclick="deleteCNewsButton()" id="deleteCNewsBt" type="button">确定删除</button> 
					<nav id="page"> </nav>
				</div>
			</div>
		</div>
