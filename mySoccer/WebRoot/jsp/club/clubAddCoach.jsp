...
<%-- <div class="container" style="width:100%;background:url('${pageContext.request.contextPath }/imgs/loginBackgd.jpg');">
 ...
 <div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		<font color="#3164af" size="5px">创建新教练</font>ADD COACH
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath }/addNewCoach" method="post" enctype = "multipart/form-data">
		...
		<!-- 	 <input type="hidden" name="method" value="regist">      -->
			 ...
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="email" class="form-control" class="required" id="coachNumber" name="coachNumber" placeholder="请输入教练邮箱"><span id="s1"></span>
			  ...
			  <!--  <div class="form-group" >
			   ...
			   <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" class="required" id="coachPassword" name="coachPassword"  placeholder="请设置密码(初始密码建议123456)">
			    </div><span style="color:red">*</span>
			 ...
			 <!--  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="coachRealName" name="coachRealName"  placeholder="请输入教练姓名">
			    </div><span style="color:red">*</span>
			  </div>
			 <!-- <div class="form-group">
			...
			<label class="radio-inline">
			 ...
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="coachTelPhone" name="coachTelPhone" placeholder="请输入教练电话号码" >		      
			    </div><span style="color:red">*</span>
			  </div>	
			 <!--  <div class="form-group">
