...
<script type="text/javascript">
	var i = "0";
	function receiveCoachBt(coachId) {
		i = coachId;
	}
	
	function refuseCoachBt(coachId) {
		i = coachId;
	}
	function receiveCoach() {
		location.href = "${pageContext.request.contextPath}/receiveCoach?coachId="+i;
	}
	
	function refuseCoach() {
		location.href = "${pageContext.request.contextPath}/refuseCoach?coachId="+i;
	}
</script>
	                    ...
	                    <a href="${pageContext.request.contextPath}/getCoachInformation?coachId=${p.coachId}">
	                        ...
	                        <div class="col-sm-8">
	                        	 <div class="ibox-tools">
			                         <a href="javascript:void(0)" onclick="receiveCoachBt('${p.coachId}')"  class="btn btn-success btn-xs" role="button" class="btn btn-danger btn-xs" data-toggle="modal"
					data-target="#myModal">接收</a> 
									
									<a href="javascript:void(0)" onclick="refuseCoachBt('${p.coachId}')"  class="btn btn-danger btn-xs" role="button" class="btn btn-danger btn-xs" data-toggle="modal"
						...
						<div style="width:380px;margin:0 auto;margin-top:10px;">
							<ul class="pagination" style="text-align:center; margin-top:10px;">
								...
								<c:if test="${ pageBean.currPage == 1 }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/findUnReceiveCoach?currPage=1#">&laquo;</span></a>
									</li>
								</c:if>
								<c:if test="${ pageBean.currPage != 1 }">
									<li>
										<a href="${pageContext.request.contextPath }/findUnReceiveCoach?currPage=${ pageBean.currPage-1 }" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
									</li>
								</c:if>
								...
								<c:forEach var="i" begin="1" end="${ pageBean.totalPage }">
									...
									<c:if test="${ pageBean.currPage != i }">
										<li><a href="${pageContext.request.contextPath }/findUnReceiveCoach?currPage=${ i }">${ i }</a></li>
									</c:if>	
								</c:forEach>
								...
								<c:if test="${ pageBean.currPage == pageBean.totalPage }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/findUnReceiveCoach?currPage=${ pageBean.totalPage }#" aria-label="Next">
								...
								<c:if test="${ pageBean.currPage != pageBean.totalPage }">
									<li>
										<a href="${pageContext.request.contextPath }/findUnReceiveCoach?&currPage=${ pageBean.currPage + 1 }" aria-label="Next">
											<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
								</c:if>
    ...
    <div class="modal-content">
				...
				<div class="modal-body">
					<!-- <table class="table table-bordered .table-hover">
					 ...
					 <h3 class="modal-title" id="myModalLabel">请您确认是否接受该教练的申请？</h3>
