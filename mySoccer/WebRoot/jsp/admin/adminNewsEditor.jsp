  ...
  <body>
		  ...
		  <div style="margin-top: 20px;margin-left: 20px">
		    ...
		    <!-- Indicates a successful or positive action -->
		 		...
		 		<button type="button" value="submit" id="release" onclick="doPost('${pageContext.request.contextPath }/createANewsByAdmin')"  name="release" class="btn btn-success">发布新文章</button>
    ...
    <script type="text/javascript">
      ...
      //配置onfocus函数之后，用户点击富文本区域会触发onfocus函数执行。
		...
		function doPost(url){
			...
			$.post(url,{'anewsContents':anewsContents,'anewsTitle':anewsTitle},function(data) {
		    	window.location.href="${pageContext.request.contextPath}/findANews?currPage=1";
			});
