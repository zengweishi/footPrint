...
<script type="text/javascript">
	...
	function playerReportUI(pid) {
		location.href = "${pageContext.request.contextPath}/findPlayerReport?pid="+pid;
	}
</script>
	            ...
	            <div class="col-sm-4">
	                        ...
	                        <div class="col-sm-4">
	                            ...
	                            <div class="text-center">
		                            <c:if test="${not empty delete }"> 
		                             <a href="javascript:void(0)" onclick="deletePlayerByCoach('${p.pid}')"  class="btn btn-danger btn-xs" role="button" class="btn btn-danger btn-xs" data-toggle="modal"
					data-target="#myModal">解除球员</a> 
		                             ...
		                             <c:if test="${empty delete }"> 
			                             <c:if test="${p.pCoach.coachId eq existCoach.coachId }"> 
			                             <a href="javascript:void(0)" onclick="playerReportUI('${p.pid}')"  class="btn btn-success btn-xs" role="button" >球员报告</a> 
			                            	<!-- <button type="button" class="btn btn-danger btn-sm">解除球员</button> -->
			                             </c:if> 
			                          </c:if>
		                        </div>
						...
						<div style="width:380px;margin:0 auto;margin-top:10px;">
							<ul class="pagination" style="text-align:center; margin-top:10px;">
								...
								<c:if test="${ pageBean.currPage == 1 }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/showAllPlayer?code=1&currPage=1#">&laquo;</span></a>
									</li>
								</c:if>
								<c:if test="${ pageBean.currPage != 1 }">
									<li>
								...
								<c:if test="${ pageBean.currPage == pageBean.totalPage }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/showAllPlayer?code=1&currPage=${ pageBean.totalPage }#" aria-label="Next">
