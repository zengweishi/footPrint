    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="wrapper wrapper-content animated fadeInUp">
				...
				<c:forEach var="m" items="${markList}">
                    <li>
                        <div>
                            <strong>${ fn:substring(m.sugCoachTime,0,10) }</strong>
                            <br/>
                            <strong>${ fn:substring(m.sugCoachTime,11,19) }</strong>
                            <br/>
                            <p>${ fn:substring(m.sugCoachContent,0,50) }</p>
                            <a href="javascript:void(0)" onclick="lookSugForCoachBt('${m.sugCoachId}')"  class="btn btn-default btn-xs" role="button" class="btn btn-danger btn-xs" data-toggle="modal"
