...
<script type="text/javascript">
	...
	function deleteCoachPlan() {
		location.href = "${pageContext.request.contextPath}/deleteCoachPlanByCoach?code=0&planId="+j;
	}
	function updateCoachPlan() {
		location.href = "${pageContext.request.contextPath}/updateCoachPlanJump?planId="+i;
	}
							...
							<ul class="pagination" style="text-align:center; margin-top:10px;">
								...
								<c:if test="${ pageBean.currPage == 1 }">
									<!-- <li class='disabled'>
									    ...
									    <li class="disabled"><a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=1&currPage=1#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
								</c:if>
								<c:if test="${ pageBean.currPage != 1 }">
									<li>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=1&currPage=${ pageBean.currPage-1 }" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
									</li>
								</c:if>
								...
								<c:forEach var="i" begin="1" end="${ pageBean.totalPage }">
									...
									<c:if test="${ pageBean.currPage != i }">
										<li><a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=1&currPage=${ i }">${ i }</a></li>
									</c:if>	
								</c:forEach>
								...
								<c:if test="${ pageBean.currPage == pageBean.totalPage }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=1&currPage=${ pageBean.totalPage }#" aria-label="Next">
								...
								<c:if test="${ pageBean.currPage != pageBean.totalPage }">
									<li>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=1&currPage=${ pageBean.currPage + 1 }" aria-label="Next">
											<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
								</c:if>
					...
					<c:if test="${ empty deletePlan }">
						...
						<div style="width:380px;margin:0 auto;margin-top:10px;">
							<ul class="pagination" style="text-align:center; margin-top:10px;">
								...
								<c:if test="${ pageBean.currPage == 1 }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=0&currPage=1#">&laquo;</span></a>
									</li>
								</c:if>
								<c:if test="${ pageBean.currPage != 1 }">
									<li>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=0&currPage=${ pageBean.currPage-1 }" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
									</li>
								</c:if>
								...
								<c:forEach var="i" begin="1" end="${ pageBean.totalPage }">
									...
									<c:if test="${ pageBean.currPage != i }">
										<li><a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=0&currPage=${ i }">${ i }</a></li>
									</c:if>	
								</c:forEach>
								...
								<c:if test="${ pageBean.currPage == pageBean.totalPage }">
									<li class='disabled'>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=0&currPage=${pageBean.totalPage}#" aria-label="Next">
											<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
								</c:if>
								<c:if test="${ pageBean.currPage != pageBean.totalPage }">
									<li>
										<a href="${pageContext.request.contextPath }/showUndoneCoachPlan?code=0&currPage=${ pageBean.currPage + 1 }" aria-label="Next">
											<span aria-hidden="true">&raquo;</span>
										</a>
									</li>
								</c:if>
...
<%-- 					<a href="${pageContext.request.contextPath }/deleteCNews?" id="deleteCNewsBt" class="btn btn-danger" role="button" >删除</a>  
 ...
 --%>				
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-info" onclick="updateCoachPlan()" data-dismiss="modal">修改</button>
 				    <button class="btn btn-success" onclick="writeSummary()" id="writeSummaryBt" type="button">完成并总结</button> 
					<nav id="page"> </nav>
				</div>
			</div>
		</div>
